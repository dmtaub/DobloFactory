...
function NB_BOTTOM_RADIUS_THIN(SCALE)        = (SCALE < 0.6) ? 3.25/2*LEGO_SCALE(SCALE) : 7.0/2*SCALE;
// Real DUPLO = 13.48
...
function DOBLOWALL(SCALE) = (SCALE < 0.6) ? 1.45 * LEGO_SCALE(SCALE): 1.55 *SCALE; // Lego vs. Duplo, Lego is not 2x smaller
